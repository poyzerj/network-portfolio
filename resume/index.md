...
<div class="resume-container">
  ...
  <div class="resume-section">
    ...
    <div class="education-entry">
      <div class="education-school">Western Governors University <span style="float:right;">Salt Lake City, UT</span></div>
      <div class="education-degree">Bachelor of Science, Network Engineering and Security - Cisco <span style="float:right;">May 2023</span></div>
    </div>
    <div class="education-entry">
      <div class="education-school">Iowa Lakes Community College <span style="float:right;">Estherville, IA</span></div>
      <div class="education-degree">Associate of Science, Web Development and Design <span style="float:right;">May 2012</span></div>
    </div>
  </div>
  ...
  <div class="resume-section">
    ...
    <div style="margin-bottom: 15px;">
      <div class="job-header">
        <div class="job-title">Service Desk Technician II</div>
    ...
    <div style="margin-bottom: 15px;">
      <div class="company-name">Farmers Union Industries, LLC <span style="float:right; font-weight:normal;">Redwood Falls, MN</span></div>
      <div class="company-description">Headquarters for meat processing, pet food processing, and rendering facilities located in the Midwest.</div>
      <div class="job-header">
    ...
    <div style="margin-bottom: 15px;">
      <div class="company-name">Jackpot Junction Casino Hotel <span style="float:right; font-weight:normal;">Morton, MN</span></div>
      <div class="company-description">An entertainment destination offering thrilling gaming experiences and exceptional hospitality.</div>
      <div class="job-header">
        <div class="job-title">IT Support Technician II</div>
    ...
    <div style="margin-bottom: 15px;">
      ...
      <div class="job-header">
        ...
        <div class="job-date">February 2021 – October 2022</div>
      </div>
      <ul>
        <li>Install, configure, repair, maintain, troubleshoot, and diagnose PCs, servers, network switches, routers, firewalls, wireless access points, network software, and other equipment for customer projects</li>
        <li>Deploy and troubleshoot Active Directory, Group Policies, and email systems such as Office 365 to effectively implement and manage upcoming technical projects</li>
        <li>Configure and deploy server virtualization using VMWare and VCenter to boost efficiency and agility for 1 or more operating systems for customers</li>
      </ul>
    </div>

    <div style="margin-bottom: 15px;">
      <div class="job-header">
        <div class="job-title">Level 1 Support Technician (Computer/Networking Division)</div>
    ...
    <div style="margin-bottom: 15px;">
      <div class="job-header">
        <div class="job-title">Support Specialist (Thinix Division)</div>
